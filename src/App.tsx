...
function App() {
  ...
  const decode = (input: string): string => {
    ...
    const result: string[] = [];
    if (arrDecode) {
      for (let i = 1; i < arrDecode.length; i+=2) {
        result[+arrDecode[i]] = String.fromCharCode(+arrDecode[i - 1]);
      }
